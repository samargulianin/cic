  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border bg-white/90 backdrop-blur">
      <Container className="flex h-20 items-center justify-between gap-4 py-2">
        <Link href="/" className="flex items-center" aria-label="CIC Georgia — Official Affiliate of Cambridge International College">
          <Logo sublineClassName="hidden sm:flex" />
        </Link>
